...
the input positions: position 9 contains 30, and position 10 contains 40. Add
...
int const FINISHED = 99; // immediately halt program
int const ADD = 1;       // adds together numbers read from two positions and stores the result in a third position.
int const MULTIPLY = 2;  // multiplies

vector<int> get_input()
{
  vector<int> arr;
  ifstream fileInput("./day_2_input.txt");
  string line;
